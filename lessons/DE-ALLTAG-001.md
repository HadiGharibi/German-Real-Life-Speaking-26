...
## Ziel
Natürlich und spontan über das eigene Kind im Alltag sprechen: Alter, Betreuung, Schlaf, Essen, Spielen, Stimmung und kleine Alltagssituationen.
...
- sich eingewöhnen — عادت کردن / دوره سازگاری داشتن
- gut / schlecht schlafen — خوب / بد خوابیدن
- durchschlafen — یکسره تا صبح خوابیدن
- Mittagsschlaf machen — خواب نیمروزی داشتن
- wählerisch beim Essen sein — در غذا سخت‌پسند بودن
- gerne spielen — با علاقه بازی کردن
- draußen spielen — بیرون بازی کردن
- müde / gut gelaunt / quengelig sein — خسته / خوش‌اخلاق / نق‌نقو بودن
...
- Sie versteht schon sehr viel, spricht aber noch nicht so viel.
  - خیلی چیزها را می‌فهمد، اما هنوز خیلی صحبت نمی‌کند.
...
- Wir sind gerade in der Eingewöhnungsphase.
  - الان در دوره سازگاری با مهدکودک هستیم.
...
## Alltagssprache: natürlicher sagen
به‌جای جمله‌های خیلی کتابی، این فرم‌ها در مکالمه طبیعی‌ترند:

- Sie ist zwei Jahre alt. → طبیعی و استاندارد
- Sie ist jetzt fast zwei. → بسیار رایج در گفتار
- Sie geht in den Kindergarten. → درست، ولی برای کودک خیلی کوچک در آلمان معمولاً **Kita** طبیعی‌تر است.
- Sie schläft in der Nacht gut. → درست، ولی طبیعی‌تر: **Sie schläft nachts gut.**
- Sie isst gerne Obst. → درست و طبیعی؛ در گفتار همچنین: **Obst isst sie total gern.**

## Mini-Dialog 1 — Mit einer Kollegin
...
## Typische Fragen, die man hört
- Wie alt ist sie jetzt?
- Geht sie schon in die Kita?
- Wie klappt die Eingewöhnung?
- Schläft sie schon durch?
- Macht sie noch Mittagsschlaf?
- Isst sie gut?
- Was spielt sie im Moment gern?
- Ist sie eher ruhig oder lebhaft?

## Sprechtraining
Antworte spontan auf Deutsch, jeweils in 2–3 Sätzen:

1. Wie alt ist dein Kind?
2. Wie schläft es nachts?
3. Was isst es besonders gern?
4. Was macht es gern draußen?
5. Wie ist seine Stimmung morgens?
6. Geht es schon in die Kita oder beginnt es bald?

## Schnellübung — natürlich ergänzen
...
## Aktive Sätze für heute
Diese fünf Sätze laut üben:
